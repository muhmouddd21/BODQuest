                ...
                if (searchQuery.length === 0) {
                    return (
                        <div className="text-truncate">
                            <Link to={`/todo?id=${todo.id}&type=paginate&key=${paginate}`}>{todo.title}</Link>
                        </div>
                    );
                } else {
                    return (
                        <div className="text-truncate">
                            <Link to={`/todo?id=${todo.id}&type=search&key=${searchQuery}`}>{todo.title}</Link>
                        </div>
                    );
                }
            }
